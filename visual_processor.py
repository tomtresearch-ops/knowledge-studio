...
# claude-sonnet-4-20250514 was RETIRED 2026-06-15 — every chart / whiteboard /
# handwritten / workflow capture failed on it with a retirement notice, which is why
# those captures sat empty. Repointed at the current Sonnet 2026-08-31.
MODEL_ROUTING = {
    'whiteboard':  'claude-sonnet-5',
    'handwritten': 'claude-sonnet-5',
    'chart':       'claude-sonnet-5',
...
MODEL_PRICING = {
    ...
    # kept so historical rows still cost out correctly
